# Wafer-Detection-End-to-End-Machine-Learning-Project
...
#### Data Insertion in Database
     ...
     any file has an invalid data type in any of the columns, the file is not loaded in the table and is moved to 
     "Bad_Data_Folder".
